            ...
            {[
              {
                ...
                desc: "Professionally planned fixed departures featuring curated packages with structured itineraries.",
                items: ["Europe", "UK", "Italy", "Spain", "Japan", "South Korea", "Switzerland", "Dubai", "Singapore", "Bali"],
                icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
                accent: "Global"
              },
              {
                title: "Domestic Group Tours",
                desc: "Explore India with well-organized tours covering scenic landscapes and spiritual circuits.",
                items: ["Kashmir", "Leh–Ladakh", "Shimla–Manali", "Sikkim", "Darjeeling", "Kerala", "Uttarakhand", "Dalhousie"],
                icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z",
                accent: "Domestic"
              },
              {
                title: "College & Educational Tours",
                desc: "Specialized end-to-end coordination for institutional requirements with a focus on safety and learning.",
                items: ["Industrial Visits", "Study Tours", "IV Tours", "Subject Tours", "Recreational Trips", "Cultural Exchange"],
